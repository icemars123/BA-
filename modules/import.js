      ...
      if (global.config.env.customer == 'tpcc')
      {
        ...
        (
          ...
          function(err, result)
          {
            if (!err)
            {
              if (__.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) || __.isNull(result.rows[0].id))
                resolve(null);
              else
              {
    ...
    function(resolve, reject)
    {
      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            var categoryid = __.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) ? null : result.rows[0].id;
    ...
    function(resolve, reject)
    {
      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            var productid = __.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) ? null : result.rows[0].id;
    ...
    function(resolve, reject)
    {
      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            var clientid = __.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) ? null : result.rows[0].id;
    ...
    function(resolve, reject)
    {
      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            var employeeid = __.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) ? null : result.rows[0].id;
    ...
    function(resolve, reject)
    {
      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            var accountid = __.isUndefined(result.rows) || __.isNull(result.rows) || (result.rows.length == 0) ? null : result.rows[0].id;
