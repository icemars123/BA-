...
function selectPrice(world, prices)
{
  ...
  for (var ndx = 0; ndx < prices.length; ndx++)
  {
    ...
    if (!__.isNull(p.clientid) && (p.clientid === clientid)) 
    {
  ...
  (
    ...
    function(err, client, done)
    {
      if (!err)
      {
        ...
        {
          clauses += '((upper(p1.name) like upper($' + bindno++ + ')) or (upper(p1.code) like upper($' + bindno++ + ')) or (upper(p1.attrib1) like upper($' + bindno++ + ')) or (upper(p1.attrib2) like upper($' + bindno++ + ')) or (upper(p1.attrib3) like upper($' + bindno++ + ')) or (upper(p1.attrib4) like upper($' + bindno++ + ')) or (upper(p1.attrib5) like upper($' + bindno++ + ')) or (upper(pc1.code) like upper($' + bindno++ + '))) and ';
