      ...
      (
        ...
        function(err, result)
        {
          if (!err)
          {
            ...
            {
              var uom = (__.isUndefined(result.rows[0].uom) || __.isNull(result.rows[0].uom)) ? '' : result.rows[0].uom;
              var uomsize = (__.isUndefined(result.rows[0].uomsize) || __.isNull(result.rows[0].uomsize)) ? 1 : __.sanitiseAsPrice(result.rows[0].uomsize);
            ...
            if (!err)
            {
              ...
              (
                function(p)
                {
                  ...
                  if (!__.isUndefined(p.dateexpiry) && !__.isNull(p.dateexpiry))
