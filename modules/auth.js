        ...
        function(err, result)
        {
          if (!err)
          {
            if (result.rows.length == 1)
            {
              ...
              if (!__.isUndefined(u.dateexpired) && !__.isNull(u.dateexpired))
...
function doChangePassword(tx, world)
{
  ...
  (
    function(resolve, reject)
    {
      if (!__.isUndefined(world.pwd) && !__.isNull(world.pwd) && !__.isBlank(world.pwd))
      {
        var salt = global.hat();
        var sha512 = new global.jssha('SHA-512', 'TEXT');
...
function doLogout(tx, user)
{
  ...
  (
    function(resolve, reject)
    {
      if (!__.isUndefined(user.connectionid) && !__.isNull(user.connectionid))
      {
        tx.query
        (
                                    ...
                                    (
                                      function(err)
                                      {
                                        if (!err)
                                        {
                                          ...
                                          if (!__.isUndefined(uo.uuid) && !__.isBlank(uo.uuid))
                                  ...
                                  function(err)
                                  {
                                    ...
                                    (
                                      function(ignore)
                                      {
                                        ...
                                        if (!__.isUndefined(err) && !__.isNull(err))
                                          msg += ' ' + err.message;
          ...
          function(err, result)
          {
            ...
            if (!err)
            {
              ...
              (
                function(u)
                {
                  if (!__.isUndefined(u.notes) && !__.isNull(u.notes))
                    u.notes = __.unescapeHTML(u.notes);

                  if (!__.isUndefined(u.datemodified) && !__.isNull(u.datemodified))
                    u.datemodified = global.moment(u.datemodified).format('YYYY-MM-DD HH:mm:ss');

                  if (!__.isUndefined(u.lastlogindate) && !__.isNull(u.lastlogindate))
                    u.lastlogindate = global.moment(u.lastlogindate).format('YYYY-MM-DD HH:mm:ss');

                  if (!__.isUndefined(u.lastlogoutdate) && !__.isNull(u.lastlogoutdate))
