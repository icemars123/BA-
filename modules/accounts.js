          ...
          function(err, result)
          {
            ...
            if (!err)
            {
              ...
              (
                function(a)
                {
                  if (!__.isUndefined(a.notes) && !__.isNull(a.notes))
          ...
          function(err, result)
          {
            ...
            if (!err)
            {
              ...
              (
                function(t)
                {
                  if (!__.isUndefined(t.notes) && !__.isNull(t.notes))
                    t.notes = __.unescapeHTML(t.notes);

                  if (!__.isUndefined(t.datemodified) && !__.isNull(t.datemodified))
          ...
          function(err, result)
          {
            ...
            if (!err)
            {
              ...
              (
                function(s)
                {
                  if (!__.isUndefined(s.datemodified) && !__.isNull(s.datemodified))
