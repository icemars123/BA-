...
var unSelectedClientIdAttachmentId = 1000;
...
function doDlgClientNew(parentid, clientid)
{
  ...
  function doEditorNew()
  {
      ...
      {
        doEditorNewWithoutClientId();
      }
  }

  function doEditorNewWithoutClientId() 
  {
    $('#divNewClientNotesG').datagrid
      (
        'insertRow',
        {
          index: 0,
          row: {
            id: unSelectedClientIdAttachmentId ++,
            notes: '',
            date: '',
            by: ''
          },
  ...
  function doEditorSave()
  {
    ...
    (
      ...
      function(row)
      {
        ...
        if (isnew)
          $('#divNewClientNotesG').datagrid('getData').rows[0].notes = notes;
        else
      ...
      [
        {
          ...
          handler: function()
          {
            ...
            var listNotes = $('#divNewClientNotesG').datagrid('getData');
            var notesRows = $('#divNewClientNotesG').datagrid('getRows');
