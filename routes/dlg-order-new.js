...
var unSelectedOrderIdAttachmentId = 1000;
...
function doDlgOrderNew(orderid)
{
  ...
  function doEditorNew()
  {
    if (orderid) 
      ...
      doEditorNewWithoutOrderId();
  }

  function doEditorNewWithoutOrderId() 
  {
        ...
        'insertRow',
         {
          index: 0,
          row: {
            id: unSelectedOrderIdAttachmentId++,
            notes: '',
            date: '',
            by: ''
          },
  ...
  function doEditorSave()
  {
    ...
    (
      ...
      function(row)
      {
        ...
        if (isnew) 
          $('#divNewOrderNotesG').datagrid('getData').rows[0].notes = notes;
        else 
      ...
      [
        {
          ...
          handler: function()
          {
            ...
            var listNotes = $('#divNewOrderNotesG').datagrid('getData');
